...
var l = require('./log').module('ergo-utils');
var _ = require('./not_');
...
module.exports = function() { // TODO add ability to define a macro: eg require(...)(['__BUG__', '__LINE__(__FILE__): Bug detected here'])
	...
	require('./log').logw('ENABLED macros in ' + __fnFilename(stack_offset+1) + "("+__fnLine(stack_offset+1)+ "). Their use should be disabled in Production systems");
}
